...
if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();
    ...
    $APPLICATION->SetPageProperty("title", "экзамен");
    $APPLICATION->SetPageProperty("description", "здесь что-то должно быть");
    $APPLICATION->setTitle("страница example");
?>
    <!-- MAIN CONTENT -->
    <main>
        <div class="main_catalog">
            <div class="main_catalog_item">
                <a href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/1.jpg" alt="Электронные сигареты"></a>
                <a href="#">Электронные сигареты</a>
            </div>

            <div class="main_catalog_item">
                <a href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/2.jpg" alt="Трубки"></a>
                <a href="#">Трубки</a>
            </div>

            <div class="main_catalog_item">
                <a href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/3.jpg" alt="Жидкости для заправки"></a>
                <a href="#">Жидкости для заправки</a>
            </div>

            <div class="main_catalog_item">
                <a href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/4.jpg" alt="Аккумуляторы и атомайзеры"></a>
                <a href="#">Аккумуляторы и атомайзеры</a>
            </div>

            <div class="main_catalog_item">
                <a href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/5.jpg" alt="Картриджи"></a>
                <a href="#">Картриджи</a>
            </div>

            <div class="main_catalog_item">
                <a href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/6.jpg" alt="Зарядные устройства"></a>
                <a href="#">Зарядные устройства</a>
            </div>

            <div class="main_catalog_item">
                <a href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/7.jpg" alt="Аксессуары"></a>
                <a href="#">Аксессуары</a>
            </div>

            <div class="main_catalog_item">
                <a href="#"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/8.jpg" alt="Подарочные наборы"></a>
